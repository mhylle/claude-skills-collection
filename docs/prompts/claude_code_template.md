...
1. **Initial Planning** (Orchestrator Session)
   ...
   - Read the general plan: /home/mhylle/stocktor/docs/plans/00-general-plan.md
...
2. **Task Delegation** (Orchestrator → Subagents)
   ...
   a. **Spawn Subagent** using one of these patterns:
      ...
      **Pattern 1: File Creation Tasks**
      ...
      Requirements:
      - Follow project guidelines in /home/mhylle/stocktor/CLAUDE.md
...
- [ ] Read general plan: /home/mhylle/stocktor/docs/plans/00-general-plan.md
- [ ] Read project guidelines: /home/mhylle/stocktor/CLAUDE.md
...
- `{PHASE_DOC_PATH}`: e.g., "/home/mhylle/stocktor/docs/plans/01-phase-foundation.md"
...
1. Copy the "Prompt to Use" section
...
The orchestrator coordinates; subagents implement. Keep it clean, keep it organized.
